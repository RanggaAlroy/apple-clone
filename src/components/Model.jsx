...
import { phoneSizeAnimation } from "../utils/animation"
...
const Model = () => {
    ...
    useEffect(() => {
    if(size === 'large') {
        phoneSizeAnimation(tl, small, smallRotation, '#view1', '#view2', {
      ...
      if(size ==='small') {
        phoneSizeAnimation(tl, large, largeRotation, '#view2', '#view1', {
    ...
    useGSAP(() => {
        ...
        tl.to('#heading', {y: 0, opacity: 1, delay: 0.5})
    }, [])
  return (
